...
public class NPCAnimationComponent extends GameComponent {
  ...
  public void update(float timeDelta, BaseObject parent) {
	...
	case IDLE:
	  idle(parentObject); break;
	case WALK:
	  walk(parentObject); break;
	case RUN_START:
	  runStart(parentObject); break;
	case RUN:
	  run(parentObject); break;
	case SHOOT:
	  shoot(parentObject); break;
	case JUMP_START:
	  jumpStart(parentObject); break;
	case JUMP_AIR:
	  jumpAir(parentObject); break;
	case TAKE_HIT:
	  takeHit(parentObject); break;
	case SURPRISED:
	  surprised(parentObject); break;
	case DEATH:
	  death(parentObject); break;
	default:
	  assert(false);
      }
